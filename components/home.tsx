...
export default function Home() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            const res = await axios.post('http://192.168.1.10:8000/api/register', data)
            ...
            <View className="w-full h-full px-5 pt-10  bg-zinc-950">
                ...
                >
                    ...
                    <View className="flex-row mt-2 justify-center items-center gap-0" >
                        <Text className="text-zinc-500 text-xl" >Already have an account?</Text><Pressable onPress={() => router.push("/(auth)")} ><Text className="text-blue-500 underline  text-xl ">Login</Text></Pressable>
                    </View>
                    <Toast />
                </KeyboardAvoidingView>
            </View>
