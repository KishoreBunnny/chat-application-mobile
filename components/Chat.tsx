...
export default function Chat() {
    return (
        <View className="w-full  h-full bg-zinc-950 " >
            ...
            <View className="w-full flex-row items-center justify-between px-3 py-2 h-[70px] border-b border-zinc-500/90 " >
                ...
                <View className="flex-row items-center gap-3" >
                    ...
                    <View>
                        <Text className="text-2xl text-zinc-200 font-semibold " >Kishore</Text>
            ...
            <View className="w-full h-[60px]  bg-zinc-900/50 backdrop:blur-lg  absolute flex-row justify-center items-center gap-1 pb-1  bottom-0 ">
                ...
                <View><Pressable onPress={() => { }} className="px-3 py-2 rounded-lg w-full bg-zinc-200 "><Text className="text-xl font-semibold ">Send</Text></Pressable></View>
            </View>
